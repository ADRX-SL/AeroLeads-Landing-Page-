...
import { AEROLEADS_REVIEW } from './constants';

const App: React.FC = () => {
  const content = AEROLEADS_REVIEW;
  ...
  return (
    <Layout>
      ...
      {/* What is AeroLeads + Screenshot 1 */}
            ...
            <div className="w-full md:w-1/2">
              <div className="rounded-2xl overflow-hidden shadow-2xl border border-gray-200 bg-white p-2">
                <img 
                  ...
                  alt={`${content.competitorName} Chrome Extension in Action`} 
                  className="w-full h-auto rounded-lg"
                />
              </div>
              <p className="mt-4 text-center text-sm text-gray-400 italic">Exploring the {content.competitorName} browser widget on a LinkedIn profile.</p>
            </div>
          </div>
      ...
      {/* Accuracy & Prospecting Benchmark */}
            ...
            <div className="w-full lg:w-1/2">
              ...
              <div className="bg-white rounded-2xl border border-gray-100 shadow-xl p-3 overflow-hidden">
                <img 
                  ...
                  alt={`${content.competitorName} Verification Results`} 
                  className="w-full h-auto rounded-lg"
                />
              </div>
              <div className="mt-8 p-6 bg-blue-50 rounded-xl border border-blue-100">
                <p className="text-[#3477E4] font-medium italic">
                  "The deep integration with LinkedIn remains its biggest strength. For SDRs who live in Sales Navigator, the ability to capture a dozen data points with a single click is a massive efficiency driver."
                </p>
              </div>
            </div>
            <div className="w-full lg:w-1/2">
              ...
              <div className="space-y-6 mb-12">
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 group hover:border-[#3477E4] transition-colors">
                  <div className="text-gray-500 text-xs font-bold uppercase mb-1">Email Delivery</div>
                  <div className="text-2xl font-bold text-[#121212]">Real-Time Verified Patterns</div>
                </div>
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 group hover:border-[#3477E4] transition-colors">
                  <div className="text-gray-500 text-xs font-bold uppercase mb-1">CRM Integration</div>
                  <div className="text-2xl font-bold text-[#121212]">One-Click Sync (HubSpot/Salesforce)</div>
                </div>
              </div>
              <div className="bg-[#121212] text-white p-8 rounded-2xl border border-gray-800 shadow-2xl">
                <div className="text-sm font-bold text-[#3477E4] uppercase mb-2">{content.competitorName} {content.year} Pricing</div>
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody>
                <tr className="border-b border-gray-50">
                  ...
                  <td className="py-6 px-8 text-gray-500">New lead discovery (LinkedIn)</td>
                  <td className="py-6 px-8 font-bold text-[#3477E4]">Bulk enrichment & data hygiene</td>
                </tr>
                <tr className="border-b border-gray-50">
                  <td className="py-6 px-8 font-semibold text-gray-700">Data Sourcing</td>
                  <td className="py-6 px-8 text-gray-500">Pattern discovery & server pings</td>
                  <td className="py-6 px-8 font-bold text-[#3477E4]">10+ Multi-provider Global Sources</td>
                </tr>
                <tr className="border-b border-gray-50">
                  <td className="py-6 px-8 font-semibold text-gray-700">Monitoring</td>
                  <td className="py-6 px-8 text-gray-500">None (One-time capture)</td>
                ...
                <tr className="border-b border-100">
                  ...
                  <td className="py-6 px-8 text-gray-500">Basic Format Verification</td>
                  <td className="py-6 px-8 font-bold text-[#3477E4]">AI Cleanup (Name sanitization, LLC removal)</td>
                </tr>
              </tbody>
            </table>
          </div>
